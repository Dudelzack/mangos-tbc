...
bool LoginQueryHolder::Initialize()
{
    ...
    res &= SetPQuery(PLAYER_LOGIN_QUERY_LOADFROM,            "SELECT guid, account, name, race, class, gender, level, xp, money, playerBytes, playerBytes2, playerFlags,"
                     ...
                     "health, power1, power2, power3, power4, power5, exploredZones, equipmentCache, ammoId, knownTitles, actionBars, xp_rate FROM characters WHERE guid = '%u'", m_guid.GetCounter());
...
void WorldSession::HandleCharCreateOpcode(WorldPacket& recv_data)
{
    ...
    // Custom rates system
    pNewChar->SetXpRate(sWorld.getConfig(CONFIG_UINT32_DEFAULT_CUSTOM_XP_RATE));
