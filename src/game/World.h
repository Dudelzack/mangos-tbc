...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_DEFAULT_CUSTOM_XP_RATE,
    CONFIG_UINT32_MAX_CUSTOM_XP_RATE,
    CONFIG_UINT32_MAX_CUSTOM_XP_RATE_FIRST_CHAR,
    CONFIG_UINT32_PREMIUM_MAX_CUSTOM_XP_RATE,
    CONFIG_UINT32_PREMIUM_MAX_CUSTOM_XP_RATE_FIRST_CHAR,
    CONFIG_UINT32_PREMIUM_GOLD_BONUS,
    CONFIG_UINT32_PREMIUM_REPUTATION_BONUS,
    CONFIG_UINT32_PREMIUM_HONOR_BONUS,
    CONFIG_UINT32_PREMIUM_ARENAPOINTS_BONUS,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_PREMIUM_ACCOUNT_SYSTEM_ENABLED,
